...
mux0=np.array([10.9377,1.05,5.00])
sigmax0=np.array([1.4219,0.105,1.25])
# Names of the probability density functions of the variables x
dist=['lognormal','normal','gumbel']
#
#
#   Algorithm FORM-iHLRF: Beck, 2019, pag. 88.
#
#
...
# Printing of the updated values
    ...
    datadict={'xvar':['R','D','L'],'prob_dist':dist,'mux':muxneqk,'sigmax':sigmaxneqk,
