...
#
# Step 0 - Example - Haldar & Mahadevan, 2000, pag. 218
#
def gfunc1(x):
    g=x[0]*x[1]*x[4]*(1.00-(x[5]*x[0]*x[1])/(x[3]*x[4]*x[2]))-x[6]
    return g
#
#
...
mux0=np.array([1.56,47.70,3.5,8.0,13.2,0.59,326.25])
delta0=np.array([0.036,0.15,0.21,0.045,0.086,0.05,0.17])
sigmax0=delta0*mux0
...
# Printing of the updated values
    ...
    datadict={'xvar':['as1','fy','fc','b','d','etha','m'],'prob_dist':dist,'mux':muxneqk,'sigmax':sigmaxneqk,
