...
#
# Step 0 - Example - cubic limit state function
#
def gfunc1(x):
    g=x[0]**3+x[1]**3-18.00
    return g
...
mux0=np.array([10.00,9.90])
sigmax0=np.array([5.00,5.00])
...
# Printing of the updated values
    ...
    datadict={'xvar':['x1','x2'],'prob_dist':dist,'mux':muxneqk,'sigmax':sigmaxneqk,
